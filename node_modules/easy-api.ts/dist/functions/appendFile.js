...
exports.data = {
    ...
    code: async (d) => {
        ...
        if (!content)
            return utils_1.Utils.Warn('Content is required in:', d.func);
        try {
            ...
            return utils_1.Utils.Warn('Error trying to append the provided file.', d.func);
        }
    }
};
